...
dependencyResolutionManagement {
    versionCatalogs {
        ...
        create("libs") {
            ...
            alias("kotlinx-serialization-json").to("org.jetbrains.kotlinx:kotlinx-serialization-json:1.3.0")
            ...
            alias("compose-activity").to("androidx.activity:activity-compose:1.4.0-beta01")
            alias("accompanist-navigation-animation").to("com.google.accompanist:accompanist-navigation-animation:0.19.0")
            alias("appcompat-appcompat").to("androidx.appcompat:appcompat:1.4.0-beta01")
